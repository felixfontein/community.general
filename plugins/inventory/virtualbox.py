...
description:
  ...
  - Uses a YAML configuration file that ends with C(virtualbox.[yml|yaml]) or C(vbox.[yml|yaml]).
...
options:
  ...
  enable_advanced_group_parsing:
    description:
      ...
      - When enabled, a VM that has been configured using C(VBoxManage modifyvm "vm01" --groups "/TestGroup/TestGroup2,/TestGroup3")
